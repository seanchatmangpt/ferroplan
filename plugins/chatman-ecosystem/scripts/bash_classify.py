...
#:
#: Restored verbatim by FERROPLAN-26922-02: a reconciliation merge dropped
#: this block while keeping the receipt (CE-GALL-35.agent-tool-grants) whose
#: falsifier pins it, silently reopening the bare-redirect write the fence
#: exists to close.
