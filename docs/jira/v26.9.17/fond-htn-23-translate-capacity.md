...
| 2026-09-18T01:35:00Z | PARTIAL_ALIVE | fix/translate-capacity@<wip> (worktree wt-a23) | (a) landed: PlannerLimits.max_composite_states + translate_limits_for plumbing, crates compile; neighbors green (fond_htn_micro 9, hddl_adversarial 2+9i, fond_htn_oracle 25, all 0F); (b) landed: 110s capacity re-measure (all 4 still non-convergent: 524k–813k states interned, 123k–414k queued) + `sample` profile: ~97% of BFS time in intern_state's BTreeSet<String> key compares — documented, fix out of this branch's merge-safe scope; (c) classify: translate memory limit is LIMIT:translate-states; KNOWN_MISMATCHES+demos rewritten as capacity rows; htn-ipc2023 gate serial exit 0 (13 pass, 116.5s) | htn-oracle RESULTS measure run in flight; final gates; commit || 2026-09-18T01:36:00Z | respawn-in-flight | fix/translate-capacity@6d14813 (wt-a23, uncommitted) | — | standing stays respawn-in-flight — finish-wave owns it |
| 2026-09-18T03:02:00Z | BLOCKED | fix/translate-capacity @ 75870de (branch fast-forwarded for re-dispatch; prior wave-5 wip uncommitted) | — | coordinator-close: superseded by fond-htn-65 (translate plumbing, 3rd attempt, SPLIT scope: TranslateLimits walls only, wave 6, wt-a23) | fond-htn-65 owns the seam |
