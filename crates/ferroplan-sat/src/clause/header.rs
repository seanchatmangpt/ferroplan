...
// @ 33e87693, file varisat/src/clause/header.rs).
...
impl ClauseHeader {
    ...
    pub fn set_activity(&mut self, activity: f32) {
        self.data[ACTIVITY_WORD] = activity.to_bits();
    }
}
