;; Vendored verbatim from the IPC corpus for the 0.22 Phase 7 MCV golden
;; battery: benchmarks/.ipc-corpus/ipc-2008/domains/sokoban-sequential-
;; satisficing-strips/domain.pddl (see benchmarks/ATTRIBUTION.md). The
;; three-location push join is the sokoban-t MCV class in miniature.
